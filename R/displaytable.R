...
#'
#' @param mymod A list object generated by "coocana".
#' @param ingradients A list of charaters with names of the needed ingradients where to be shown in the tables.
#' @param with.splits Logical. "TRUE" if the tables with splits information are preferred. Cannot be "TRUE" when the input model without any split information.
#' @param table.out Charater string, a choice of preferance output tables. (table.out = "stats") if only the table with statistics is needed. (table.out = "significants") if only the table with cooccurence association is needed. The default value is (table.out = "both"), which returns and shows both kinds of tables.
#' @param full_stats Charater string, a choice of preferance output of statistic tables. (full_stats = "prob") if probability values are needed in statistics table. (full_stats = "obs") shows the observed number of species occurrence or co-occurrence. The default value is (full_stats = "full"), which returns all the statistic from coocana() output.
...
#' @return Returns a list of tables in the form of data frames and tables in form of htmlwidgets.
#' \itemize{
...
#'   \item STATSFT - Significant table in the form of htmlwidget.
#' }
#' @description
